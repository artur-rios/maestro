...
void main() {
  group('ShellResolver', () {
    ...
    test(
      'GivenWindowsWithoutPowerShellSeven_WhenResolvingTheShell_'
      'ThenWindowsPowerShellIsUsed',
      () async {
    ...
    test(
      'GivenNoShellOnPath_WhenResolvingTheShell_'
      'ThenTheShellIsReportedUnavailable',
      () async {
    ...
    test(
      'GivenAnInaccessibleShell_WhenResolvingTheShell_'
      'ThenRemediationNamesPermissions',
      () async {
    ...
    test(
      'GivenAnInaccessibleFirstCandidate_WhenAnotherIsUsable_'
      'ThenTheUsableShellIsChosen',
      () async {
    ...
    test(
      'GivenAResolutionWithAnArgumentPrefix_WhenResolvingTheShell_'
      'ThenThePrefixPrecedesTheShellArguments',
      () async {
