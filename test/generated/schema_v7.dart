...
class LocalRecoveryCodes extends Table with TableInfo {
  @override
  final GeneratedDatabase attachedDatabase;
  final String? _alias;
  LocalRecoveryCodes(this.attachedDatabase, [this._alias]);
  late final GeneratedColumn<String> id = GeneratedColumn<String>(
    'id',
    aliasedName,
    false,
  ...
  late final GeneratedColumn<String> userId = GeneratedColumn<String>(
    ...
    type: DriftSqlType.string,
    requiredDuringInsert: true,
    $customConstraints: 'NOT NULL REFERENCES local_users(id)ON DELETE CASCADE',
  );
  ...
  @override
  LocalRecoveryCodes createAlias(String alias) {
    return LocalRecoveryCodes(attachedDatabase, alias);
  }
...
class DatabaseAtV7 extends GeneratedDatabase {
  ...
  late final LocalRecoveryCodes localRecoveryCodes = LocalRecoveryCodes(this);
