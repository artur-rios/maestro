...
void main() {
  group('OpenProjectTerminal', () {
    test('GivenAnAvailableProjectFolder_WhenOpeningATerminal_'
        'ThenASessionIsReturned', () async {
    ...
    test('GivenAMissingProjectFolder_WhenOpeningATerminal_'
        'ThenFolderUnavailableIsReturned', () async {
    ...
    test('GivenAMissingProjectFolder_WhenOpeningATerminal_'
        'ThenTheProjectRecordIsUntouched', () async {
    ...
    test('GivenAnInaccessibleProjectFolder_WhenOpeningATerminal_'
        'ThenFolderUnavailableIsReturned', () async {
    ...
    test('GivenAnUnavailableShell_WhenOpeningATerminal_'
        'ThenShellUnavailableIsReturnedWithRemediation', () async {
    ...
    test('GivenAnUnavailablePseudoTerminal_WhenOpeningATerminal_'
        'ThenTheShellUnavailableFailureIsReported', () async {
    ...
    test('GivenAnUnexpectedStartFailure_WhenOpeningATerminal_'
        'ThenTheRawErrorIsNotSurfaced', () async {
