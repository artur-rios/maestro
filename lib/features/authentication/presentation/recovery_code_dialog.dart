...
final class _RecoveryCodeDialogState extends State<RecoveryCodeDialog> {
  ...
  final FocusScopeNode _modalFocusScope = FocusScopeNode(
    debugLabel: 'Recovery code acknowledgement',
    traversalEdgeBehavior: TraversalEdgeBehavior.closedLoop,
    directionalTraversalEdgeBehavior: TraversalEdgeBehavior.closedLoop,
  );
  final FocusNode _acknowledgementFocus = FocusNode(
    debugLabel: 'Acknowledge recovery codes',
  );
  ...
  void initState() {
    ...
    WidgetsBinding.instance.addPostFrameCallback((_) {
      if (mounted) _acknowledgementFocus.requestFocus();
    });
  }
  ...
  void dispose() {
    _plaintext.clear();
    widget.recoveryCodes.clear();
    _acknowledgementFocus.dispose();
  ...
  Widget build(BuildContext context) {
    return FocusTraversalGroup(
      child: FocusScope.withExternalFocusNode(
        focusScopeNode: _modalFocusScope,
        autofocus: false,
        child: PopScope(
          canPop: false,
          child: Semantics(
            ...
            child: AlertDialog(
              ...
              actions: <Widget>[
                FilledButton(
                  focusNode: _acknowledgementFocus,
